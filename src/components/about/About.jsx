  ...
  return (
    <div className="a">
      ...
      <div className="a-right">
        ...
        <div>
          <button><a href="https://drive.google.com/file/d/1kzD9n3TkxOl5KThzvHXj8BJQp5KZODKz/view?usp=sharing" target="_blank" rel="noreferrer">Download my resume!</a></button>
        </div>
      </div>
    </div>
  );
