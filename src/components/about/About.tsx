  ...
  return (
    <div className="a">
      ...
      <div className="a-right">
        ...
        <div>
          <button><a href="https://drive.google.com/file/d/1dAi0iYEwMT8UzotJHg_CPufbQFhvlCd4/view?usp=sharing" target="_blank" rel="noreferrer">Download my resume!</a></button>
        </div>
      </div>
    </div>
  );
